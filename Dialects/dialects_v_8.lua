...
-- Alternate title: Druidic - language: Tier
Lore_Archive["Druidic"] = Lore_Archive["Tier"];


-- Alternate title: Yserran - language: Tier
Lore_Archive["Yseran"] = Lore_Archive["Tier"];
